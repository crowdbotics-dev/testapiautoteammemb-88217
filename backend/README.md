...
## Project Structure
    ...
    ├── testapiautoteammemb_88217  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_88217`
...
2. Clone this repo and `cd testapiautoteammemb_88217`
